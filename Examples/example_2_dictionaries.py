...
#books.sort(key=lambda book: book['published_year']) lamba can be used to pass the function input separated by commans and then : and then return
books.sort(key=book_sort_key) # key takes function as object no calling needed sort will call the function on two different objects
print(books)
#my_dict = {1: 'int', 1.0 : 'float', True: 'bool'} result {1:bool} hash of 1 1.0 and True are same
